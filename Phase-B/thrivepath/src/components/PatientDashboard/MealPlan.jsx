    ...
    <div className="bg-white p-6 rounded-xl shadow-md font-sans">
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-5 rounded-lg shadow-md hover:shadow-lg transition-colors"
          disabled={loading}
        >
          {loading ? (
            <>
