    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
      ...
      <div className="bg-cyan-50 p-4 rounded-lg mb-4 flex items-center">
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-cyan-900">{hydration.totalWater}</p>
        </div>
      </div>
        ...
        <div className="space-y-2">
          {hydration.tips.map((tip, idx) => (
            <div key={idx} className="flex items-start p-2 bg-white rounded border border-blue-100">
              <svg className="h-5 w-5 mr-2 text-blue-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path d="..." />
              </svg>
